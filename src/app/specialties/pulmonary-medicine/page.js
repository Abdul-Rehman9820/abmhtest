            ...
            <div className="commonheadcontainer">
              <div className="breadcrumbs">
                <div className="breadcrumbsdata">
                  Home / Our Specialties / <span className="breadcrumbsactive">Pulmonary Medicine</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="spectitlegrcont">
              <div className="spectitlegrcont2">
                ...
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/bronchoscopy">
                    ...
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">Bronchoscopy</p>
                    </div>
                  </Link>
                </div>
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/ebus-endoscopic-bronchial-ultrasound">
                    <div className="testimgboxcot1">
                      <Image width={400} height={400} src="/specialityviewimag/Internal Services.jpg" alt="img" />
                    </div>
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">EBUS (Endoscopic Bronchial Ultrasound)</p>
                    </div>
                  </Link>
                </div>
