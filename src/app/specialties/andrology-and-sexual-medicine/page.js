...
const Andrologyandsexualmedicine = () => {
  ...
  return (
    ...
    <>
      <title>Andrology & Sexual Medicine</title>
            ...
            <div className="commonheadcontainer">
              <div className="breadcrumbs">
                <div className="breadcrumbsdata">
                  Home / Our Specialties / <span className="breadcrumbsactive">Andrology & Sexual Medicine</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="spectitlegrcont">
              <div className="spectitlegrcont2">
                ...
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/sexology">
                    ...
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">Sexology</p>
                    </div>
                  </Link>
                </div>
