            ...
            <div className="commonheadcontainer">
              <div className="breadcrumbs">
                <div className="breadcrumbsdata">
                  Home / Our Specialties / <span className="breadcrumbsactive">Surgical Oncology</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="spectitlegrcont">
              <div className="spectitlegrcont2">
                ...
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/head-&-neck">
                    ...
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">Head & Neck</p>
                    </div>
                  </Link>
                </div>
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/onco-gynec">
                    <div className="testimgboxcot1">
                      <Image width={400} height={400} src="/specialityviewimag/Internal Services.jpg" alt="img" />
                    </div>
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">Onco Gynec</p>
                    </div>
                  </Link>
                </div>
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/breast-cancer">
                    <div className="testimgboxcot1">
                      <Image width={400} height={400} src="/specialityviewimag/Internal Services.jpg" alt="img" />
                    </div>
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">Breast Cancer</p>
                    </div>
                  </Link>
                </div>
                <div className="testimgboxcont">
                ...
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/onco-uro">
                    <div className="testimgboxcot1">
                      <Image width={400} height={400} src="/specialityviewimag/Internal Services.jpg" alt="img" />
                    </div>
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">Onco Uro</p>
                    </div>
                  </Link>
                </div>
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/breast">
                    <div className="testimgboxcot1">
                      <Image width={400} height={400} src="/specialityviewimag/Internal Services.jpg" alt="img" />
                    </div>
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">Breast</p>
                    </div>
                  </Link>
                </div>
