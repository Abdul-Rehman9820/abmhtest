...
const Baritricandmetabolicsurgery = () => {
            ...
            <div className="spectitlegrcont">
              <div className="spectitlegrcont2">
                ...
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/bariatric-surgery">
                    ...
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">Bariatric Surgery</p>
                    </div>
                  </Link>
                </div>
...
export default Baritricandmetabolicsurgery;
