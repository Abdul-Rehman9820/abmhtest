...
const Accidentandemergency = () => {
  ...
  return (
    ...
    <>
      <title>Dietetics & Nutrition (Lifestyle)</title>
            ...
            <div className="commonheadcontainer">
              <div className="breadcrumbs">
                <div className="breadcrumbsdata">
                  Home / Our Specialties / <span className="breadcrumbsactive">Dietetics & Nutrition (Lifestyle)</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="spectitlegrcont">
              <div className="spectitlegrcont2">
                ...
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/diet-counselling">
                    ...
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">Diet Counselling</p>
                    </div>
                  </Link>
                </div>
