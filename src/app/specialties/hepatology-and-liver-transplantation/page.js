...
const Accidentandemergency = () => {
  ...
  return (
    ...
    <>
      <title>Hepatology and Liver transplantation</title>
            ...
            <div className="commonheadcontainer">
              <div className="breadcrumbs">
                <div className="breadcrumbsdata">
                  Home / Our Specialties / <span className="breadcrumbsactive">Hepatology and Liver transplantation</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="spectitlegrcont">
              <div className="spectitlegrcont2">
                ...
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/liver-transplant">
                    ...
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">Liver Transplant</p>
                    </div>
                  </Link>
                </div>
