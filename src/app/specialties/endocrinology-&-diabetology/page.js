...
const Accidentandemergency = () => {
  ...
  return (
    ...
    <>
      <title>Endocrinology & Diabetology</title>
            ...
            <div className="commonheadcontainer">
              <div className="breadcrumbs">
                <div className="breadcrumbsdata">
                  Home / Our Specialties / <span className="breadcrumbsactive">Endocrinology & Diabetology</span>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/endocrine-surgery">
                    ...
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">Endocrine Surgery</p>
                    </div>
                  </Link>
                </div>
