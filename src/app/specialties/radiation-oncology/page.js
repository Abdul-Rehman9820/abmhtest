            ...
            <div className="commonheadcontainer">
              <div className="breadcrumbs">
                <div className="breadcrumbsdata">
                  Home / Our Specialties / <span className="breadcrumbsactive">Radiation Oncology</span>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/brachytherapy">
                    ...
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">Brachytherapy</p>
                    </div>
                  </Link>
                </div>
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/radiation">
                    ...
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">Radiation</p>
                    </div>
                  </Link>
                </div>
