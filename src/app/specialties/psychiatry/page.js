            ...
            <div className="commonheadcontainer">
              <div className="breadcrumbs">
                <div className="breadcrumbsdata">
                  Home / Our Specialties / <span className="breadcrumbsactive">Psychiatry</span>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/mental-health">
                    ...
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">Mental Health</p>
                    </div>
                  </Link>
                </div>
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/clinical-psychology">
                    ...
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">Clinical Psychology</p>
                    </div>
                  </Link>
                </div>
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/counselling">
                    ...
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">Counselling</p>
                    </div>
                  </Link>
                </div>
