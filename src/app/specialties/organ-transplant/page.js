            ...
            <div className="commonheadcontainer">
              <div className="breadcrumbs">
                <div className="breadcrumbsdata">
                  Home / Our Specialties / <span className="breadcrumbsactive">Organ Transplant</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="spectitlegrcont">
              <div className="spectitlegrcont2">
                ...
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/kidney-transplant">
                    ...
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">Kidney Transplant</p>
                    </div>
                  </Link>
                </div>
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/cornea-transplant">
                    <div className="testimgboxcot1">
                      <Image width={400} height={400} src="/newspecilitymainimage/sub_specilityimages/Cornea Transplant.png" alt="img" />
                    </div>
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">Cornea Transplant</p>
                    </div>
                  </Link>
                </div>
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/bone-marrow-transplant">
                    <div className="testimgboxcot1">
                      <Image width={400} height={400} src="/specialityviewimag/Internal Services.jpg" alt="img" />
                    </div>
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">Bone Marrow Transplant</p>
                    </div>
                  </Link>
                </div>
