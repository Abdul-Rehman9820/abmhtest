            ...
            <div className="commonheadcontainer">
              <div className="breadcrumbs">
                <div className="breadcrumbsdata">
                  Home / Our Specialties / <span className="breadcrumbsactive">General Surgery </span>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/minimal-invasive-&-laparoscopic-surgery">
                    ...
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">Minimal Invasive & Laparoscopic Surgery</p>
                    </div>
                  </Link>
                </div>
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/laparoscopic-surgery">
                    ...
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">Laparoscopic Surgery</p>
                    </div>
                  </Link>
                </div>
                <div className="testimgboxcont">
                  <Link href="/specialties-sub/proctology">
                    ...
                    <div className="testimgboxcot2">
                      <p className="testimgtitle">Proctology</p>
                    </div>
                  </Link>
                </div>
          ...
          <div className="specsingleparn">
            <div className="spectitleimgbox">
              <div className="">
                ...
                General Surgery at Aditya Birla Memorial Hospital covers a broad spectrum of surgical interventions, addressing various medical conditions.
                </p>
