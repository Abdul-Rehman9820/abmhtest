...
const Diabetologyandendocrinology = () => {
  ...
  return (
    ...
    <>
      <title>Diabetology & Endocrinology</title>
            ...
            <div className="commonheadcontainer">
              <div className="breadcrumbs">
                <div className="breadcrumbsdata">
                  Home / Our Specialties / <span className="breadcrumbsactive">Diabetology & Endocrinology</span>
                </div>
              </div>
            </div>
          </div>
...
export default Diabetologyandendocrinology;
