...
const Accreditations = () => {
  ...
  return (
    ...
    <>
      <title>Achievement & Accreditations</title>
            ...
            <div className="commonheadcontainer">
              <div className="breadcrumbs">
                <div className="breadcrumbsdata">
                  About Us / <span className="breadcrumbsactive">Achievement & Accreditations</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="AchiveandAcrre">
            <div className="Specialtiespartbof">
              <div className="Specialtiesheadbof">
                <h1 className="oursepperbof">Achievement & Accreditations</h1>
