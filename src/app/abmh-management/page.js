      ...
      <div className="parentcontainerwhi">
        <div className="customcontainer">
          <div className="Csrpolmain2">
            ...
            <div className="cstbloglayot">
              <div className="cstbloglayot1">
                <Image width={400} height={400} src="/bodimg/Mr-Pamesh-Gupta.jpg" alt="img" />
              </div>
              <div className="cstbloglayot2">
                <div className="cstbloglayothead">Mr. Pamesh Gupta</div>
                <div className="cstbloglayothead2">CEO</div>
                <div className="cstbloglayotpara">
                  With an illustrious career spanning over two decades, Mr. Pamesh Gupta currently occupies the esteemed role of Chief
                  Executive Officer at Aditya Birla Memorial Hospital, showcasing his adeptness in leadership and strategic management.
                  His vision is to steer Aditya Birla Memorial Hospital towards sustained growth, innovation, and excellence in patient care,
                  ensuring its enduring reputation as a trusted healthcare institution for generations to come. Before assuming this pivotal position, he held significant roles within the telecommunications industry,
                  notably serving as EVP - Business Management at Vodafone Idea Ltd, where he distinguished himself as Business Head.
                </div>
                ...
                <div className="cstbloglayotpara">
                  Mr. Pamesh Gupta&apos;s extensive experience is underpinned by a strong educational background. He holds a Master of
                  Business Administration (MBA) in Marketing from McGill University, a Master of Science (MS) in Electrical and
                  Electronics Engineering from the University of Nottingham, and a Bachelor of Engineering (B.E.) in Electrical,
                  Electronics, and Communications Engineering from Malviya Regional Engineering College. His journey underscores a
                  compelling fusion of academic prowess and practical expertise, positioning him as a formidable leader in the healthcare arena.
                </div>
            ...
            <div className="cstbloglayot" >
              ...
              <div className="cstbloglayot2">
                ...
                <div id="Mr-Pankaj-Kumar-Jain"></div>
            ...
            <div className="cstbloglayot" >
              <div className="cstbloglayot1">
                <Image width={400} height={400} src="/bodimg/Mr-Pankaj-Kumar-Jain.jpg" alt="img" />
              </div>
              <div className="cstbloglayot2">
                <div className="cstbloglayothead">Mr. Pankaj Kumar Jain</div>
                <div className="cstbloglayothead2">Chief Financial Officer</div>
                <div className="cstbloglayotpara">
                  Pankaj Kumar Jain currently holds the esteemed position of Chief Financial Officer at Aditya Birla Group, bringing a wealth of experience that spans over three decades. His significant contributions include a seven-year tenure as the President of Finance & Taxation at Essel Mining and Industries Limited. In this role, he adeptly headed the finance and taxation functions for various businesses and units within the mineral and mining sector of the Aditya Birla Group, showcasing exceptional leadership and financial acumen.
                </div>

                <div id="Mr-Vijay-Gole"></div>

                <div className="cstbloglayotpara">
                  A distinguished professional, Pankaj Kumar Jain is a Chartered Accountant (CA) with a Graduation in Cost and Works Accountancy (CWA) from The Institute of Chartered Accountants of India. His educational journey, coupled with vast experience, positions him as a stalwart in the financial domain. With over three decades of dedicated service, including roles as Senior Vice President at Aditya Birla Group, Pankaj Kumar Jain continues to exemplify excellence in financial management, making invaluable contributions to the success of the Aditya Birla Group.
                </div>
            ...
            <div className="cstbloglayot" >
              <div className="cstbloglayot1">
                <Image width={400} height={400} src="/bodimg/Mr-Vijay-Gole.jpg" alt="img" />
              </div>
              <div className="cstbloglayot2">
                <div className="cstbloglayothead">Mr. Vijay Gole</div>
                <div className="cstbloglayothead2">Head - HR & General Administration</div>
                <div className="cstbloglayotpara">
                With a wealth of expertise spanning over two decades, Mr. Vijay Gole, our esteemed Head of HR & General Administration at Aditya Birla Hospitals, has been at the forefront of workforce management since September 2023. In this pivotal role, he orchestrates a positive work environment, spearheads impactful change initiatives, and ensures the seamless and efficient administration of the hospital&apos;s non-clinical functions. Notably, his distinguished career includes a significant tenure as the Head of HR for Sales & Marketing at Birla White. Here, Mr. Gole played a pivotal role in cultivating an agile and engaged workforce across India, contributing significantly to maintaining the No.1 position and enhancing the brand&apos;s premium status.
                </div>
                <div className="cstbloglayotpara">
                A distinguished alumnus of the Jamnalal Bajaj Institute of Management Studies, Mr. Gole holds a Master of Business Administration (MBA) with a distinction in Human Resources Development. His educational journey also features a post-graduate diploma in System Management from NIIT Training Centre and a Bachelor of Science in Chemistry from Wilson College. With an illustrious career that spans across organizations like UltraTech Cement, Aditya Birla Group HQ, and Anand Rathi Financial Services and Citigroup, Mr. Gole&apos;s strategic prowess and holistic understanding of HR functions have left an indelible mark in each role he has undertaken.
                </div>
