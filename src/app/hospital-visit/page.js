                          ...
                          <div className="whychoslideboxts">
                            <div className="whychobox1ts">
                              <div className="whychospects">
                                <h2>
                                  Delighted mother, Mrs. Radha Gaikwad, praises
                                  Aditya Birla Memorial Hospital. Under Dr.
                                  Molshri Misra&apos;s care, she appreciates the
                                  skilled medical attention and supportive
                                  staff, expressing sincere gratitude for a
                                  positive experience during the child birth.
                                </h2>
                              </div>
                            </div>
                        ...
                        <div className="whychochinewlbo">
                          <div className="whychoslideboxts">
                            <div className="whychobox1ts">
                              <div className="whychospects">
                                <h2>
                                  Bhaskar Bange praises Aditya Birla Memorial
                                  Hospital for impeccable cleanliness and
                                  unwavering focus on sanitization. Enduring
                                  Dialysis since July 2015, he lauds the
                                  hospital&apos;s commitment to infection
                                  control, outstanding staff, service and
                                  infrastructure.
                                </h2>
                              </div>
                            </div>
                        ...
                        <div className="whychochinewlbo">
                          <div className="whychoslideboxts">
                            <div className="whychobox1ts">
                              <div className="whychospects">
                                <h2>
                                  Cancer survivor Mrs. Aruna Hiwarkar thanks
                                  Aditya Birla Memorial Hospital for Dr.
                                  Wategaonkar&apos;s expertise and the
                                  supportive team. Regular check-ups reflect her
                                  well-being, emphasizing the hospital&apos;s
                                  responsive care and advanced facilities.
                                </h2>
                              </div>
                            </div>
                            <div className="whychoimgbox2ts">
                        ...
                        <div className="whychochinewlbo">
                          <div className="whychoslideboxts">
                            <div className="whychobox1ts">
                              <div className="whychospects">
                                <h2>
                                  Kudos to Mr. Dharmendra Pashine, a resilient
                                  patient who underwent painless Robotic Surgery
                                  for Umbilical Hernia at Aditya Birla Memorial
                                  Hospital. Dr. Suprashant Kulkarni&apos;s
                                  skilled hands ensured the quick recovery of
                                  Mr. Pashine. He&apos;s grateful to the
                                  hospital staff and advancements.
                                </h2>
                              </div>
                            </div>
                            <div className="whychoimgbox2ts">
              ...
              >
                <div className="carousel-inner">
                  <div className="carousel-item active">
                    <div>
                      <div className="newtesti-Para">
                        Delighted mother, Mrs. Radha Gaikwad, praises Aditya
                        Birla Memorial Hospital. Under Dr. Molshri Misra&apos;s
                        care, she appreciates the skilled medical attention and
                        supportive staff, expressing sincere gratitude for a
                        positive experience during the child birth.
                      </div>
                      ...
                      <div>
                        <h2 className="newtesti-name">
                          Mrs. Radha Anirudh Gaikwad
                        </h2>
                      </div>
                      <div>
                        <h2 className="newtesti-cont">
                  ...
                  <div className="carousel-item">
                    <div>
                      <div className="newtesti-Para">
                        Bhaskar Bange praises Aditya Birla Memorial Hospital for
                        impeccable cleanliness and unwavering focus on
                        sanitization. Enduring Dialysis since July 2015, he
                        lauds the hospital&apos;s commitment to infection
                        control, outstanding staff, service and infrastructure.
                      </div>
                      <div className="newtesti-Parawhychoimgts">
                        <Image
                          width={400}
                  ...
                  <div className="carousel-item">
                    <div>
                      <div className="newtesti-Para">
                        Cancer survivor Mrs. Aruna Hiwarkar thanks Aditya Birla
                        Memorial Hospital for Dr. Wategaonkar&apos;s expertise
                        and the supportive team. Regular check-ups reflect her
                        well-being, emphasizing the hospital&apos;s responsive
                        care and advanced facilities.
                      </div>
                      <div className="newtesti-Parawhychoimgts">
                        <Image
                          width={400}
                  ...
                  <div className="carousel-item">
                    <div>
                      <div className="newtesti-Para">
                        Kudos to Mr. Dharmendra Pashine, a resilient patient who
                        underwent painless Robotic Surgery for Umbilical Hernia
                        at Aditya Birla Memorial Hospital. Dr. Suprashant
                        Kulkarni&apos;s skilled hands ensured the quick recovery
                        of Mr. Pashine. He&apos;s grateful to the hospital staff
                        and advancements.
                      </div>
                      <div className="newtesti-Parawhychoimgts">
                        <Image
