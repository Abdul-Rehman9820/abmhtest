            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Dialysis</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Dialysis services provide life-sustaining treatment for patients with kidney failure. Our dialysis unit offers hemodialysis and peritoneal dialysis options, ensuring comprehensive care for individuals with renal conditions.
                </p>
