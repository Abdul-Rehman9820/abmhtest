            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Endoscopy & ERCP</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Endoscopy & ERCP services involve minimally invasive procedures to visualize and treat conditions within the digestive tract. Our expert endoscopists utilize advanced techniques, including ERCP (Endoscopic Retrograde Cholangiopancreatography), for diagnostic and therapeutic interventions.
                </p>
