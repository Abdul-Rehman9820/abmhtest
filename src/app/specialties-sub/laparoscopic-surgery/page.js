            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Laparoscopic Surgery</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Laparoscopic Surgery involves minimally invasive procedures performed through small incisions. Our expert surgeons utilize laparoscopy for various abdominal surgeries, offering benefits such as shorter recovery times and reduced scarring.
                </p>
