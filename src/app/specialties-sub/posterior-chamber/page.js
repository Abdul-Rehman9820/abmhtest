            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Posterior Chamber</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                The Posterior Chamber service addresses conditions affecting the back part of the eye, including the retina and vitreous. Our ophthalmologists offer specialized care for posterior segment disorders.
                </p>
