            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Nephrology</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Nephrology services focus on the diagnosis and management of kidney disorders. Our nephrologists utilize advanced diagnostic tools and therapeutic interventions to ensure optimal kidney health.
                </p>
