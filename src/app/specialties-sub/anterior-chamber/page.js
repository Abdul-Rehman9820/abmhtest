            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Anterior Chamber</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                The Anterior Chamber service focuses on the diagnosis and treatment of conditions affecting the front part of the eye, including the cornea and iris. Our ophthalmologists provide comprehensive care for various anterior segment disorders.
                </p>
