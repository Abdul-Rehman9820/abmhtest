            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Joint Replacement</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Joint Replacement services offer surgical solutions for individuals with degenerative joint conditions, such as osteoarthritis. Our orthopedic surgeons specialize in performing joint replacement surgeries, including hip and knee replacements, to alleviate pain and improve joint function.
                </p>
