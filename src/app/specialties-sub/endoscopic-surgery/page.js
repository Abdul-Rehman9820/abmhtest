            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Endoscopic Surgery</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Endoscopic Surgery in Otolaryngology focuses on minimally invasive procedures for diagnosing and treating disorders of the ear, nose, and throat. Our ENT specialists utilize endoscopic techniques to provide precise and effective interventions.
                </p>
