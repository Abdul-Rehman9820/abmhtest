            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Electrophysiology & Ablation</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Electrophysiology focuses on the electrical activity of the heart. Ablation procedures involve using catheters to correct abnormal heart rhythms (arrhythmias). Our specialists employ precise mapping and ablation techniques to restore normal heart rhythm.
                </p>
