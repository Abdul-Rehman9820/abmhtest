            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Dermotologist</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Dermatologists at Aditya Birla Memorial Hospital specialize in the diagnosis and treatment of skin disorders. Our comprehensive dermatology service addresses conditions ranging from acne to skin cancer.
                </p>
