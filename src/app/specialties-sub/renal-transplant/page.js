            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Renal Transplant</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Renal Transplantation involves the surgical replacement of a diseased kidney with a healthy donor kidney. Our experienced transplant team ensures a multidisciplinary approach to provide comprehensive care for patients requiring renal transplantation.
                </p>
