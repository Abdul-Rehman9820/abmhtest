            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">General Dentistry</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                General Dentistry provides comprehensive oral care, including preventive services, restorative procedures, and routine check-ups, ensuring overall dental health for patients.
                </p>
