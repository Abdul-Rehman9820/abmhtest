            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">EUS (Endoscopic Ultrasound)</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Endoscopic Ultrasound (EUS) is a specialized procedure that combines endoscopy with ultrasound imaging for detailed assessments of the digestive organs. Our skilled gastroenterologists use EUS for accurate diagnosis and staging of gastrointestinal conditions.
                </p>
