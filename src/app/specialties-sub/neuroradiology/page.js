            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Neuroradiology</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Neuroradiology services specialize in imaging techniques for the diagnosis and treatment planning of neurological conditions. Our neuroradiologists utilize advanced imaging modalities for accurate assessments.
                </p>
