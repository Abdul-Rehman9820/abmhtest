            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Glaucoma</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Glaucoma services specialize in the diagnosis and management of glaucoma, a group of eye conditions that can lead to optic nerve damage and vision loss. Our ophthalmologists employ advanced diagnostic tools and treatment modalities to preserve vision.
                </p>
