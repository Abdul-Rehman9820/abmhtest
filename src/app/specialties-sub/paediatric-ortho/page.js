            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Paediatric Ortho</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Paediatric Orthopaedics focuses on the diagnosis and treatment of orthopedic conditions in children. Our specialized pediatric orthopedic surgeons provide individualized care, addressing developmental issues, fractures, and musculoskeletal disorders in pediatric patients.
                </p>
