            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Neuro Rehab</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Neurological Rehabilitation (Neuro Rehab) is a specialized program designed to help individuals recover and improve function after neurological injuries or diseases. Our neurorehabilitation team provides tailored rehabilitation plans to enhance the quality of life for patients.
                </p>
