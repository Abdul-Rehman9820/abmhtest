            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Fetal Anomalies</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                The Fetal Anomalies service specializes in the diagnosis and management of abnormalities in the developing fetus. Our expert team utilizes advanced imaging techniques and diagnostic procedures to identify and address fetal anomalies, ensuring comprehensive prenatal care.
                </p>
