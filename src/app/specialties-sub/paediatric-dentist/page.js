            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Paediatric Dentist</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Our Paediatric Dentistry service focuses on the oral health of children. Specially trained dentists provide preventive and therapeutic care to address unique dental needs during childhood.
                </p>
