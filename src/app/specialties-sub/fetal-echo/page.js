            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Fetal Echo</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Fetal Echo is a specialized ultrasound service that focuses on evaluating the heart structure and function of the developing fetus. Our skilled sonographers and cardiologists work collaboratively to provide detailed assessments, facilitating early detection and intervention for cardiac abnormalities.
                </p>
