            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Hair Transplant</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                The Hair Transplant service provides advanced solutions for hair restoration, addressing conditions like male pattern baldness. Our skilled team utilizes cutting-edge techniques to ensure natural-looking results.
                </p>
