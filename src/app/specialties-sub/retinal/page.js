            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Retinal</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Retinal services specialize in the diagnosis and treatment of retinal disorders. Our experienced retinal specialists utilize advanced imaging techniques and surgical interventions to manage conditions such as retinal detachment and diabetic retinopathy.
                </p>
