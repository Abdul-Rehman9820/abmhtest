            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Paediatric Cardiologist</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Pediatric Cardiologists focus on the diagnosis and management of heart conditions in children. Our pediatric cardiology team provides specialized care, including diagnostic testing and ongoing management, to ensure the well-being of pediatric patients.
                </p>
