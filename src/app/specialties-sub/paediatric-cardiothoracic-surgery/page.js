            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Paediatric Cardiothoracic Surgery</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                : Paediatric Cardiothoracic Surgery caters to the surgical needs of children with congenital or acquired heart conditions. Our specialized pediatric surgeons perform a range of cardiac procedures, ensuring the highest level of care for young patients.
                </p>
