            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Hepatology</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Hepatology focuses on the diagnosis and management of liver diseases. Our hepatologists provide comprehensive care for conditions such as liver cirrhosis, hepatitis, and liver tumors, utilizing advanced diagnostic tools and treatment modalities.
                </p>
