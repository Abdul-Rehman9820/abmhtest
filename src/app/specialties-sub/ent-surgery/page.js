            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">ENT Surgery</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                ENT Surgery at Aditya Birla Memorial Hospital encompasses a range of surgical interventions for conditions affecting the ear, nose, and throat. Our experienced ENT surgeons ensure comprehensive care, addressing issues such as sinus disorders, tonsillectomy, and vocal cord surgeries.
                </p>
