            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Amino</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                The Amino service focuses on prenatal genetic testing, providing valuable insights into the health and development of the fetus. Amino offers advanced genetic screening to assess the risk of genetic disorders, ensuring early detection and informed decision-making for expectant parents.
                </p>
