            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Cath Lab </h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                The Cath Lab is a specialized facility equipped with advanced imaging technology for diagnostic and interventional cardiac procedures. Our skilled cardiologists perform catheter-based procedures, including angiography and angioplasty, to diagnose and treat coronary artery disease.
                </p>
