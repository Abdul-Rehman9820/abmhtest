            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Audiometry</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Audiometry services involve the assessment of hearing function. Our audiologists utilize advanced techniques to measure hearing sensitivity and diagnose hearing impairments, allowing for tailored interventions and support.
                </p>
