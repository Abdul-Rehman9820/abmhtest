            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Proctology</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Proctology is a specialized service focusing on the diagnosis and treatment of disorders affecting the rectum and anus. Our proctologists provide comprehensive care for conditions like hemorrhoids, anal fissures, and colorectal polyps.
                </p>
