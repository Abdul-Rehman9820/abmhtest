            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Clinical Dermatology</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Clinical Dermatology involves the diagnosis and management of various skin conditions. Our dermatologists employ evidence-based approaches to offer personalized care for dermatological issues.
                </p>
