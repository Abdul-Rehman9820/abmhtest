            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Cosmetology</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Cosmetology focuses on non-surgical aesthetic procedures to enhance skin health and appearance. Our expert cosmetologists offer treatments such as chemical peels, laser therapy, and injectables.
                </p>
