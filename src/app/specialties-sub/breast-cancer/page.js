            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Breast Cancer</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Breast Cancer Surgery is a specialized service aimed at the surgical management of breast cancer. Our expert surgeons conduct breast-conserving surgeries, mastectomies, and reconstructive procedures with a focus on achieving optimal oncological outcomes while considering the aesthetic and emotional well-being of the patient.
                </p>
