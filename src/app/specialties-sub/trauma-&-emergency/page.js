            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Trauma & Emergency</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Trauma & Emergency services at Aditya Birla Memorial Hospital provide immediate and specialized care for patients with traumatic injuries. Our dedicated trauma team ensures rapid assessment, stabilization, and appropriate interventions, aiming for the best possible outcomes in emergency situations.
                </p>
