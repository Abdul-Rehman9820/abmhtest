            ...
            <div className="spectitleimgbox">
              <div className="">
                <div className="spectitle Specialtiesheadgr">
                  <h1 className="spetileh2gr">Shoulder</h1>
                  <span className="headbordergr" />
                </div>
                <p className="specilpara">
                Shoulder services specialize in the diagnosis and treatment of shoulder-related conditions, including injuries, arthritis, and rotator cuff disorders. Our orthopedic specialists employ advanced techniques to restore shoulder function and alleviate pain.
                </p>
